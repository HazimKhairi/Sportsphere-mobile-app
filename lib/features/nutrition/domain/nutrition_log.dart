...
class NutritionLog {
  ...
  factory NutritionLog.fromDoc(String id, Map<String, dynamic> d) {
    ...
    return NutritionLog(
      ...
      totalProteinG: (d['totalProteinG'] as num?)?.toDouble() ?? 0,
      totalFatG: (d['totalFatG'] as num?)?.toDouble() ?? 0,
      totalCarbsG: (d['totalCarbsG'] as num?)?.toDouble() ?? 0,
      totalFibreG: (d['totalFibreG'] as num?)?.toDouble() ?? 0,
