...
String _$drillCompletionRepositoryHash() =>
    r'58483a1f0a7f1b7b5f36985edc5440d94420150d';

/// See also [drillCompletionRepository].
@ProviderFor(drillCompletionRepository)
final drillCompletionRepositoryProvider =
    Provider<DrillCompletionRepository>.internal(
      drillCompletionRepository,
      name: r'drillCompletionRepositoryProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$drillCompletionRepositoryHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef DrillCompletionRepositoryRef = ProviderRef<DrillCompletionRepository>;
